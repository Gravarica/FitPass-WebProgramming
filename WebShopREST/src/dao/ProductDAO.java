...
public class ProductDAO {
	...
	public Product save(Product product) {
		...
		System.out.println("Usao sam u cuvanje");
		maxId++;
	...
	public void delete(String id) {
		System.out.println("Usao sam u brisanje proizvoda");
		this.products.remove(id);
	}
	
	public List<Product> search(String parameter){
		ArrayList<Product> returnCollection = new ArrayList<Product>();
		for (Product p : products.values()) {
			if(p.containsInName(parameter)) returnCollection.add(p);
		}
