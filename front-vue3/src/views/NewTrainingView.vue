          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form onsubmit="scheduleTraining()">
              ...
              <div class="d-grid gap-2 pt-5 md-6">
                <input class=" btn-lg btn-grad" type="button" @click="scheduleTraining()" value="Submit"/>
              </div>
            </form>
          </div>
        </div>
...
import {reactive,computed} from 'vue'
    ...
    export default {
      ...
      methods: {
            fillTrainings(id){
                axios
                    .get('http://localhost:8081/WebShopREST/rest/trainings/sport_object/with_trainer/' + id)
                    .then((response) =>{
